...
#ifndef ZEPHYR_DRIVERS_SENSOR_BATTERY_MAX17260_H_
#define ZEPHYR_DRIVERS_SENSOR_BATTERY_MAX17260_H_
...
/* MAX17260 specific channels */
enum max17260_channel {
	MAX17260_COULOMB_COUNTER,
};

struct max17260_data {
