...
#define BMI160_INT_LATCH_2560MS	0xE

/* BMI160_REG_INT_MAP: physical interrupts */
#define BMI160_INT_MAP_FLAT		BIT(7)
#define BMI160_INT_MAP_ORIENT	BIT(6)
#define BMI160_INT_MAP_S_TAP_EN	BIT(5)
#define BMI160_INT_MAP_D_TAP_EN	BIT(4)
#define BMI160_INT_MAP_NOMO		BIT(3)
#define BMI160_INT_MAP_ANYM		BIT(2)
#define BMI160_INT_MAP_HIGHG	BIT(1)
#define BMI160_INT_MAP_LOWG		BIT(0)

/* BMI160_REG_INT_MAP: Data driven interrupts */
#define BMI160_INT1_MAP_DRDY		BIT(7)
#define BMI160_INT1_MAP_FWM			BIT(6)
#define BMI160_INT1_MAP_FFULL		BIT(5)
#define BMI160_INT1_MAP_PMU_TRIG	BIT(4)
#define BMI160_INT2_MAP_DRDY		BIT(3)
#define BMI160_INT2_MAP_FWM			BIT(2)
#define BMI160_INT2_MAP_FFULL		BIT(1)
#define BMI160_INT2_MAP_PMU_TRIG	BIT(0)
