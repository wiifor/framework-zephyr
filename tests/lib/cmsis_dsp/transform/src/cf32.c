...
DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, noisy_16, &arm_cfft_sR_f32_len16,
	in_cfft_noisy_16, ref_cfft_noisy_16, 32);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, noisy_32, &arm_cfft_sR_f32_len32,
	in_cfft_noisy_32, ref_cfft_noisy_32, 64);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, noisy_64, &arm_cfft_sR_f32_len64,
	in_cfft_noisy_64, ref_cfft_noisy_64, 128);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, noisy_128, &arm_cfft_sR_f32_len128,
	in_cfft_noisy_128, ref_cfft_noisy_128, 256);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, noisy_256, &arm_cfft_sR_f32_len256,
	in_cfft_noisy_256, ref_cfft_noisy_256, 512);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, noisy_512, &arm_cfft_sR_f32_len512,
	in_cfft_noisy_512, ref_cfft_noisy_512, 1024);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, noisy_1024, &arm_cfft_sR_f32_len1024,
	in_cfft_noisy_1024, ref_cfft_noisy_1024, 2048);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, noisy_2048, &arm_cfft_sR_f32_len2048,
	in_cfft_noisy_2048, ref_cfft_noisy_2048, 4096);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, noisy_4096, &arm_cfft_sR_f32_len4096,
	in_cfft_noisy_4096, ref_cfft_noisy_4096, 8192);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, step_16, &arm_cfft_sR_f32_len16,
	in_cfft_step_16, ref_cfft_step_16, 32);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, step_32, &arm_cfft_sR_f32_len32,
	in_cfft_step_32, ref_cfft_step_32, 64);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, step_64, &arm_cfft_sR_f32_len64,
	in_cfft_step_64, ref_cfft_step_64, 128);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, step_128, &arm_cfft_sR_f32_len128,
	in_cfft_step_128, ref_cfft_step_128, 256);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, step_256, &arm_cfft_sR_f32_len256,
	in_cfft_step_256, ref_cfft_step_256, 512);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, step_512, &arm_cfft_sR_f32_len512,
	in_cfft_step_512, ref_cfft_step_512, 1024);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, step_1024, &arm_cfft_sR_f32_len1024,
	in_cfft_step_1024, ref_cfft_step_1024, 2048);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, step_2048, &arm_cfft_sR_f32_len2048,
	in_cfft_step_2048, ref_cfft_step_2048, 4096);

DEFINE_TEST_VARIANT4(arm_cfft_f32_cmplx, step_4096, &arm_cfft_sR_f32_len4096,
...
DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, noisy_16, &arm_cfft_sR_f32_len16,
	in_cifft_noisy_16, in_cfft_noisy_16, 32);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, noisy_32, &arm_cfft_sR_f32_len32,
	in_cifft_noisy_32, in_cfft_noisy_32, 64);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, noisy_64, &arm_cfft_sR_f32_len64,
	in_cifft_noisy_64, in_cfft_noisy_64, 128);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, noisy_128, &arm_cfft_sR_f32_len128,
	in_cifft_noisy_128, in_cfft_noisy_128, 256);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, noisy_256, &arm_cfft_sR_f32_len256,
	in_cifft_noisy_256, in_cfft_noisy_256, 512);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, noisy_512, &arm_cfft_sR_f32_len512,
	in_cifft_noisy_512, in_cfft_noisy_512, 1024);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, noisy_1024, &arm_cfft_sR_f32_len1024,
	in_cifft_noisy_1024, in_cfft_noisy_1024, 2048);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, noisy_2048, &arm_cfft_sR_f32_len2048,
	in_cifft_noisy_2048, in_cfft_noisy_2048, 4096);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, noisy_4096, &arm_cfft_sR_f32_len4096,
	in_cifft_noisy_4096, in_cfft_noisy_4096, 8192);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, step_16, &arm_cfft_sR_f32_len16,
	in_cifft_step_16, in_cfft_step_16, 32);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, step_32, &arm_cfft_sR_f32_len32,
	in_cifft_step_32, in_cfft_step_32, 64);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, step_64, &arm_cfft_sR_f32_len64,
	in_cifft_step_64, in_cfft_step_64, 128);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, step_128, &arm_cfft_sR_f32_len128,
	in_cifft_step_128, in_cfft_step_128, 256);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, step_256, &arm_cfft_sR_f32_len256,
	in_cifft_step_256, in_cfft_step_256, 512);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, step_512, &arm_cfft_sR_f32_len512,
	in_cifft_step_512, in_cfft_step_512, 1024);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, step_1024, &arm_cfft_sR_f32_len1024,
	in_cifft_step_1024, in_cfft_step_1024, 2048);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, step_2048, &arm_cfft_sR_f32_len2048,
	in_cifft_step_2048, in_cfft_step_2048, 4096);

DEFINE_TEST_VARIANT4(arm_cifft_f32_cmplx, step_4096, &arm_cfft_sR_f32_len4096,
