...
Applications for the ``bl654_dvk_lora`` board configuration can be built, flashed,
...
NOTE: On the BL654 DVK LORA, the FTDI USB should be used to access the UART console.
...
Testing Bluetooth on the BL654 DVK LORA
***********************************
Many of the Bluetooth examples will work on the BL654 DVK LORA.
Try them out:
...
Testing the LEDs and buttons on the BL654 DVK LORA
************************************************
...
:zephyr_file:`boards/arm/bl654_dvk_lora/bl654_dvk_lora.dts`.
